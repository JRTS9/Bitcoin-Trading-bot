...
/*
 * ANX.hk API written by github.com/BTCDude
 */
public class ANXapi extends MarketApi {
    private String baseurl = "https://anx.hk/gapiv2/";
    private String tickerurl = "https://anx.hk/gapiv2/BTCUSD/money/ticker";
    ...
    public void update() {
        URL url;
        MarketModel ANXHK = new MarketModel();
        try {
            url = new URL(tickerurl);
            JSONObject jo = new JSONObject(new JSONTokener(url.openStream())).getJSONObject("data");
            ANXHK.setHigh(jo.getJSONObject("high").getDouble("value"));
            ANXHK.setLow(jo.getJSONObject("low").getDouble("value"));
            ANXHK.setAvg(jo.getJSONObject("avg").getDouble("value"));
            ANXHK.setBuy(jo.getJSONObject("buy").getDouble("value"));
            ANXHK.setSell(jo.getJSONObject("sell").getDouble("value"));
            ANXHK.setLast(jo.getJSONObject("last").getDouble("value"));
            ANXHK.setVwap(jo.getJSONObject("vwap").getDouble("value"));
